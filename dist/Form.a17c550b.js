...
})({"g3pzg":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "f779703aa17c550b";
"use strict";
...
},{"6d18d6bd340e7473":"786KC","74ad5ea14201648c":"1dldy"}],"4Yvuo":[function(require,module,exports) {
...
function Form() {
    ...
    const [formValues, setFormValues] = (0, _react.useState)(initialValues);
    const [formErrors, setFormErrors] = (0, _react.useState)({});
    const [isSubmit, setIsSubmit] = (0, _react.useState)(false);
    ...
    const handleSubmit = (e)=>{
        ...
        if (formValues.subject != "" && formValues.query != "" && formValues.contact != "" && formValues.level != "") {
            (0, _axiosDefault.default).post("https://jsonplaceholder.typicode.com/posts", {
                formValues
            }).then((res)=>{
                console.log(res);
                (0, _reactToastify.toast).success("Submitted successfully");
            }).catch((err)=>console.log(err));
            (0, _browserDefault.default).sendForm("service_t20j8dv", "template_66wja3i", form.current, "xzyGaCQDylMsqiMcX").then((result)=>{
                console.log(result.text);
                (0, _reactToastify.toast).success("Email send Successfully");
            }, (error)=>{
    ...
    const validate = (values)=>{
        ...
        if (!values.query) errors.query = "*Query is required!";
        if (!values.contact) errors.contact = "*Contact is required!";
        else if (!p.test(values.contact)) errors.contact = "*Should be number only!";
        else if (values.contact.length != 10) errors.contact = "*Contact number should be of 10 digits";
        if (!values.level) errors.level = "*Level is required!";
        return errors;
    };
    return /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("div", {
        className: "flex flex-col items-center gap-3 max-w-2xl m-auto",
        children: [
            /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("div", {
                className: "w-full h-24 absolute bg-gray-600",
                children: [
                    /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("h2", {
                        className: "text-4xl text-white font-bold mt-4 ml-4",
                    ...
                    /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("p", {
                        className: "mt-1 ml-4 text-white",
                        children: "Response to this E-mail will be send to your registered E-mail"
                    }, void 0, false, {
                        fileName: "src/components/Form.js",
                        lineNumber: 79,
                        columnNumber: 13
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("label", {
                        children: [
                            /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("h4", {
                                className: "text-xl font-medium mb-1",
                                children: "Mention your Query Here"
                            }, void 0, false, {
                                fileName: "src/components/Form.js",
                                lineNumber: 104,
                                columnNumber: 17
                    ...
                    /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("label", {
                        children: [
                            /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("h4", {
                                className: "flex items-center text-xl font-medium mb-1",
                                children: [
                                    "Attachments",
                                    /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("p", {
                            ...
                            /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("div", {
                                        className: "w-36 flex flex-col items-center py-1 bg-gray-400 shadow-md tracking-wide cursor-pointer hover:bg-white hover:text-gray-600 text-black ease-linear transition-all duration-150",
                                        children: [
                                    ...
                                    /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("p", {
                                        children: "*. Images should be in JPG format."
                                    }, void 0, false, {
                                        fileName: "src/components/Form.js",
                                        lineNumber: 131,
                                        columnNumber: 21
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("label", {
                                children: [
                                    /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("h4", {
                                        className: "text-xl font-medium mb-1",
                                        children: "How critical is your request"
                                    }, void 0, false, {
                                        fileName: "src/components/Form.js",
                                        lineNumber: 147,
                                        columnNumber: 21
                    ...
                    Object.keys(formErrors).length === 0 && isSubmit ? /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)((0, _reactToastify.ToastContainer), {}, void 0, false, {
                        fileName: "src/components/Form.js",
                        lineNumber: 166,
                        columnNumber: 17
                    }, this) : "",
                    /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("button", {
                        className: "px-5 py-1 bg-green-500 hover:bg-green-800 text-white font-medium ease-linear transition-all duration-150",
                        children: "Submit"
                    }, void 0, false, {
                        fileName: "src/components/Form.js",
                        lineNumber: 170,
...
_s(Form, "v3FzvL/vpN361tCFPELPrKZFdR0=");
_c = Form;
...
},{"react/jsx-dev-runtime":"iTorj","react":"21dqq","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js":"km3Ru","axios":"jo6P5","react-toastify":"kSvyQ","react-toastify/dist/ReactToastify.css":"gJP2Y","@emailjs/browser":"kbSqr"}],"jo6P5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gJP2Y":[function() {},{}],"kbSqr":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../../store/store":"3eehJ","../../utils/validateParams":"5GPWw","../../api/sendPost":"3pmzm","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["g3pzg","1xC6H"], null, "parcelRequire0099")

//# sourceMappingURL=Form.a17c550b.js.map
